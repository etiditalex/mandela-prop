...
export default async function AgriculturalLandPage() {
  const properties = await getLandProperties("agricultural");
    ...
    <section className="px-4 py-20 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl leading-8 text-zinc-600">
          Discover agricultural plots suited for farming, agritech ventures, orchards,
          ranching, and long-term land banking in high-potential growth corridors.
        </p>
        </div>
        ...
        <div className="mt-10">
          {properties.length > 0 ? (
            ...
            <div className="rounded-3xl border border-dashed border-zinc-300 bg-white p-10 text-center text-zinc-600">
              No agricultural land listings are currently available in the database.
            </div>
          )}
        </div>
      </div>
