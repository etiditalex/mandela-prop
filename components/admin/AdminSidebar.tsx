...
import { Building2, ExternalLink, Home, LayoutDashboard, MapPin, Settings, Users, ClipboardList, Newspaper, Mic, KeyRound } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { label: "Rentals", href: "/agent/rentals", match: "/agent/rentals", icon: KeyRound },
