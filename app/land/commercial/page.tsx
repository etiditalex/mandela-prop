...
export default async function CommercialLandPage() {
  const properties = await getLandProperties("commercial");
    ...
    <section className="px-4 py-20 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl leading-8 text-zinc-600">
          Find commercial sites positioned for retail centers, offices, hospitality,
          mixed-use projects, and high-visibility business expansion.
        </p>
        </div>
        ...
        <div className="mt-10">
          {properties.length > 0 ? (
            ...
            <div className="rounded-3xl border border-dashed border-zinc-300 bg-white p-10 text-center text-zinc-600">
              No commercial land listings are currently available in the database.
            </div>
          )}
        </div>
      </div>
